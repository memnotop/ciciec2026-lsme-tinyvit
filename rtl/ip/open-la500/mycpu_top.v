...
(
    ...
    // External LSME instruction sideband.  A CDC bridge in soc_top carries
    // this blocking request/response channel into the system clock domain.
    output          lacc_ext_req_valid,
    input           lacc_ext_req_ready,
    output   [ 2:0] lacc_ext_req_command,
    output   [ 6:0] lacc_ext_req_imm,
    output   [31:0] lacc_ext_req_rj,
    output   [31:0] lacc_ext_req_rk,
    input           lacc_ext_rsp_valid,
    input    [31:0] lacc_ext_rsp_rdata,
...
`ifdef HAS_LACC
    ...
    .lacc_req_ready       (lacc_ext_req_ready  ),
...
lacc_core u_lacc_core(
    ...
    .ext_req_valid   (lacc_ext_req_valid),
    .ext_req_ready   (lacc_ext_req_ready),
    .ext_req_command (lacc_ext_req_command),
    .ext_req_imm     (lacc_ext_req_imm),
    .ext_req_rj      (lacc_ext_req_rj),
    .ext_req_rk      (lacc_ext_req_rk),
    .ext_rsp_valid   (lacc_ext_rsp_valid),
    .ext_rsp_rdata   (lacc_ext_rsp_rdata)
    );
`endif
