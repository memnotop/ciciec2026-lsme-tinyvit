...
// The unlocked BTB lookup may contain don't-care/X data while a previously
// accepted prediction is held.  A masked OR lets those unknowns corrupt the
// buffered target; use an actual mux for all prediction fields.
assign btb_ret_pc_t = btb_lock_en ? btb_lock_buffer[31:0]  : btb_ret_pc;
assign btb_index_t  = btb_lock_en ? btb_lock_buffer[36:32] : btb_index;
assign btb_taken_t  = btb_lock_en ? btb_lock_buffer[37]    : btb_taken;
assign btb_en_t     = btb_lock_en ? 1'b1                   : btb_en;
